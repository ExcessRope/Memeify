...
public class EnterTextActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap selectedImageBitmap = BitmapResizer.ShrinkBitmap(pictureUri.toString(),
    ...
    private void saveImageToGallery(Bitmap memeBitmap) {
        ...
        if (!originalImage) {
            ...
            // Create intent to request newly created file to be scanned, pass picture
            // uri and broadcast intent
